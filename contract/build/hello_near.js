...
class Token {
  constructor(tokenId, ownerId, name, description, mediaURI, level) {
...
let Contract = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = view(), _dec6 = view(), _dec(_class = (_class2 = class Contract {
  ...
  init({
    ...
    this.ownerId = ownerId;
    this.ownerByToken = new LookupMap(prefix);
    this.tokenList = new LookupMap(null);
  }
  mintNft({
    tokenOwnerId,
    ...
    let token = new Token(newTokenId, tokenOwnerId, name, description, mediaURI, level);
  ...
  getTokenById({
    ...
    return typeof this.tokenList.get(tokenId.toString());
  }
  getTotalSupply() {
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "mintNft", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "mintNft"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTokenById", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getTokenById"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTotalSupply", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "getTotalSupply"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getAllToken", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "getAllToken"), _class2.prototype)), _class2)) || _class);
function getAllToken() {
  ...
  const _result = _contract.getAllToken(_args);
...
function getTokenById() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.getTokenById(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
function mintNft() {
  const _state = Contract._getState();
  ...
  const _args = Contract._getArgs();
  const _result = _contract.mintNft(_args);
...
export { getAllToken, getTokenById, getTotalSupply, init, mintNft };
